...
class App extends Component {
	...
	convertFeedbackNumberToFeedback = guess => {
		...
		let { correctNumbers, correctLocations } = guess;

		return `correct numbers: ${correctNumbers} | correct locations ${correctLocations}`;
	};
							...
							<div className="home-page">
								...
								<div className="game">
									...
									<div className="guesses-container">
										{hintIsReady && currentGuesses.length < 10 && (
											<p className="hint-available-note">
												Hint is available!
											</p>
										)}{" "}
										{currentGuesses.length > 0 ? (
