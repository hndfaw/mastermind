    ...
    return (
      <div className="guess-card">
        <div className="guess-card-part-1" style={this.partOneAndTwoStyle()}>
          <p
            className="guess-card-num guess-card-num-1"
            style={this.codeNumStyle(0, guess[0])}
          >
            {guess[0]}
          </p>
          <p
            className="guess-card-num guess-card-num-2"
            style={this.codeNumStyle(1, guess[1])}
          >
            {guess[1]}
          </p>
          <p
            className="guess-card-num guess-card-num-3"
            style={this.codeNumStyle(2, guess[2])}
          >
            {guess[2]}
          </p>
          <p
            className="guess-card-num guess-card-num-4"
            style={this.codeNumStyle(3, guess[3])}
          >
            {guess[3]}
          </p>
        </div>
